...
public class ProcessoSeletivo {
  ...
  static void entrandoEmContato(String candidato) {
    ...
    if (atendeu) {
      System.out.println("CONSEGUIMOS CONTATO COM O CANDIDATO " + candidato + " APÓS " + tentativasRealizadas
          + " TENTATIVAS");
    } else {
      System.out.println("NÃO CONSEGUIMOS CONTATO COM O CANDIDATO " + candidato + ", NÚMERO MÁXIMO DE "
